...
import (
	...
	cloudsdk "github.com/ysicing/k3s-autoscaler/pkg/provider"
	"log"
)
...
func (p *provider) create(ctx context.Context, opts cloudsdk.InstanceCreateOpts) (*cloudsdk.Instance, error) {
	...
	response, err := p.getCvmClient().RunInstances(request)
	if err != nil {
		return nil, err
	}
...
//		},
//	}
//	response, err := p.getCvmClient().DescribeInstances(request)
//	if err != nil {
//		return nil, err
//	}
